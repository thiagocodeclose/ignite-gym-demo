    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to top, rgba(10,10,10,1) 25%, rgba(10,10,10,0.7) 60%, rgba(10,10,10,0.2) 100%)",
          }}
        />
        {/* Red glow at center */}
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 80%, rgba(228,0,43,0.15) 0%, transparent 55%)",
          }}
        />
      </div>
      ...
      <div className="relative z-10 w-full pb-20 md:pb-28">
        <div className="container-wide">
          ...
          <Reveal delay={0.12}>
            ...
            >
              {tagline.content || studio.tagline}
            </p>
          </Reveal>
          <Reveal delay={0.2}>
            <div className="flex flex-wrap gap-4">
              <Link
                href={
                  bookingIntegration.booking_enabled
